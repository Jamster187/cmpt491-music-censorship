...
def main(output="reports/post_run_audit.md", decisions="../docs/post_run_audit.md"):
    ...
    lines=['# Post-run acquisition audit', '', f'Generated by `python3 src/post_run_audit.py` from read-only local databases, evidence files, and caches. No requests or acquisition writes. See [audit decisions]({decisions}) for validation and next steps.',
...
if __name__=='__main__':
    ...
    parser.add_argument('--output',default='reports/post_run_audit.md')
