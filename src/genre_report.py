...
def render():
    ...
    lines+=['','All 60 case notes and the review selection rule are in [review.json](genre/review.json). The main table above shows representative failures and boundaries.', '', '## Historical coverage diagnostics','',
    ...
    (ROOT/'reports/genre_assignment_feasibility.md').write_text('\n'.join(lines)+'\n')
