...
Full immutable revisions and SHA-256 files are in [the artifact manifest](../reports/classifier_panel/artifacts.json). The original LyricLens Git revision is `71a40996c1021c62d12dc004cbafa3f1c5560162`; Detoxify is `d5376446b6accee5dd2d346f2d3050f9d8a69af1`. The three new hub revisions are respectively `d75048347613a25d77de8cf6412eaae9fa7b26be`, `f2f1202b1bdeb07342385c3f807f9c07cd8f5cf8`, and `d7645e127eaf1aefc7862fd59a17a5aa8558b8ce`. No third-party weights, token IDs or lyric text are distributed.
...
[The machine-readable theme specification](classifier_panel_themes.json) was committed before new panel inference. It freezes **17** themes, their rationale and the hypothesis template `This song contains {}.`:
