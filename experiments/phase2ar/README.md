...
outputs. Reports are generated at `reports/phase2ar_metadata_feasibility.md` and
`reports/phase2ar_review.md`; qualitative review notes are maintained separately.
