...
provider. No lyrics are retrieved. See the [source decision](../../intermediate_reports/phase2a_source_research.md)
and [results report](../../intermediate_reports/phase2a_metadata_feasibility.md).
...
- `archive/intermediate_reports/phase2a_metadata_feasibility.md`: generated results; do not edit manually.
