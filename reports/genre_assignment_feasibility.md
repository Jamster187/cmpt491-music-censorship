...
All 60 case notes and the review selection rule are in [review.json](genre/review.json). The main table above shows representative failures and boundaries.
